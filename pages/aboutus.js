        ...
        <section class="mb-32 text-gray-800 text-center">
            ...
            <div class="mb-6 lg:mb-0">
                ...
                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                    <img src="https://media-exp1.licdn.com/dms/image/C4D03AQFR94UTJmk0-A/profile-displayphoto-shrink_400_400/0/1661206751624?e=1676505600&v=beta&t=CLE10pD0VGqohMG_ainLnotP8zFd2WXFqtRli8rK-DA" class="w-full rounded-t-lg" />
                    <a href="#!">
            ...
            <div class="mb-6 lg:mb-0">
                <div class="bg-white block rounded-lg shadow-lg">
                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                    <img src="https://media-exp1.licdn.com/dms/image/C5103AQFejZLkqSPKXQ/profile-displayphoto-shrink_400_400/0/1517103793919?e=1676505600&v=beta&t=CUZM9gO-Qlqxb0pUi4CiTWTGmFcY9rRx9IZRPILCXQw" class="w-full rounded-t-lg" />
                    <a href="#!">
                    <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                    </a>
                    <svg class="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" styles="left: 0; bottom: 0">
                ...
                <div class="p-6">
                    ...
                    <a href="https://www.linkedin.com/in/john-yooham-jung-497294113/" class="px-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-4 h-4 text-blue-600">
                        <path fill="currentColor" d="M100.28 448H7.4V148.9h92.88zM53.79 108.1C24.09 108.1 0 83.5 0 53.8a53.79 53.79 0 0 1 107.58 0c0 29.7-24.1 54.3-53.79 54.3zM447.9 448h-92.68V302.4c0-34.7-.7-79.2-48.29-79.2-48.29 0-55.69 37.7-55.69 76.7V448h-92.78V148.9h89.08v40.8h1.3c12.4-23.5 42.69-48.3 87.88-48.3 94 0 111.28 61.9 111.28 142.3V448z" />
                        </svg>
                    </a>
            ...
            <div class="">
                <div class="bg-white block rounded-lg shadow-lg">
                <div class="relative overflow-hidden bg-no-repeat bg-cover">
                    <img src="https://media-exp1.licdn.com/dms/image/C5603AQEXt5MB1HK6BA/profile-displayphoto-shrink_400_400/0/1552658064150?e=1676505600&v=beta&t=mRRAeRchq56ATRygZmjXAFuF9N4t73u2ghBCJ3I_KGI" class="w-full rounded-t-lg" />
                    <a href="#!">
                    <div class="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed"></div>
                    </a>
                    <svg class="absolute" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" styles="left: 0; bottom: 0">
